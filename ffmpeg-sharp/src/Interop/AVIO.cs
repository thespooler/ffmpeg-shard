...
namespace FFmpegSharp.Interop
{
    ...
    public unsafe partial class FFmpeg
    {
        ...
        */
        ...
        [DllImport(AVFORMAT_DLL_NAME)]
        public static extern void put_tag(ref ByteIOContext s, [MarshalAs(UnmanagedType.LPStr)]string tag);

        [DllImport(AVFORMAT_DLL_NAME)]
        public static extern void put_strz(ref ByteIOContext s, [MarshalAs(UnmanagedType.LPStr)]string buf);
        ...
        /// </remarks>
        [DllImport(AVFORMAT_DLL_NAME)]
        public static extern int url_fopen(ref ByteIOContext s, [MarshalAs(UnmanagedType.LPStr)]string filename, int flags);
